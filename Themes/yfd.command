...
rm -r $PIX*
cd "`dirname "$0"`"
cp -a PixmapsDark/. $PIX
sed -i.bak "s/^ResourceFile:.*/ResourceFile:..\/..\/Applications\/FontForge.app\/Contents\/Resources\/opt\/local\/share\/fontforge\/pixmaps\/YosemiForgeDark.theme/" $PREF
